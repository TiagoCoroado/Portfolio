      ...
      <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10">
        ...
        <nav>
          ...
          <div className="grid grid-flow-col gap-4">
            ...
            <a
              href="https://github.com/tiagocoroado"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
              ...
              >
                <title>GitHub</title>
                <path d="M12 .297C5.375.297 0 5.672 0 12.297c0 5.304 3.438 9.797 8.207 11.387.6.109.793-.261.793-.577v-2.173c-3.338.726-4.042-1.609-4.042-1.609-.546-1.387-1.332-1.754-1.332-1.754-1.089-.744.082-.729.082-.729 1.205.084 1.839 1.238 1.839 1.238 1.07 1.835 2.805 1.304 3.491.997.108-.776.42-1.304.764-1.604-2.664-.304-5.462-1.332-5.462-5.931 0-1.311.469-2.384 1.239-3.221-.124-.305-.537-1.521.117-3.167 0 0 1.01-.321 3.311 1.23a11.437 11.437 0 0 1 3.017-.405c1.023.004 2.051.138 3.018.405 2.299-1.551 3.306-1.23 3.306-1.23.656 1.646.243 2.862.12 3.167.772.837 1.236 1.911 1.236 3.221 0 4.61-2.802 5.624-5.473 5.922.43.372.82 1.104.82 2.226v3.302c0 .318.192.691.801.575C20.566 22.092 24 17.6 24 12.297 24 5.672 18.627.297 12 .297z" />
              </svg>
            </a>
